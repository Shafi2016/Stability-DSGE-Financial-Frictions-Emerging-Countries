%% IDEIR Model with additive Risk Premium, Call it IDEIR(a) Dynare 4.5.7
...
stoch_simul(order=3,pruning, periods = 50000, drop= 1000,  irf=0);// IDEIR
//simulations = pruning_abounds(M_, options_, 3,'fernandez-villaverde_et_al'); 
