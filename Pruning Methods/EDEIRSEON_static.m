function [residual, g1, g2] = EDEIRSEON_static(y, x, params)
%
...
T52 = exp(y(2))-T50/params(2);
T55 = T52^(-params(1));
T70 = exp(y(8))*params(9)*(1+exp(y(4))*params(7)/exp(y(6))-params(5)+params(8)*(exp(y(5))-exp(y(6))*params(5)));
T121 = getPowerDeriv(T52,(-params(1)),1)*(-(exp(y(3))*getPowerDeriv(exp(y(3)),params(2),1)/params(2)));
lhs =y(1);
...
residual(10) = y(10);
lhs =y(11);
rhs =params(6)*(exp(y(1)-params(11))-1)+params(6)*y(1)*exp(y(1)-params(11));
residual(11)= lhs-rhs;
lhs =exp(y(12));
rhs =y(11)+params(10);
residual(12)= lhs-rhs;
...
if nargout >= 2,
  ...
  g1(5,2)=exp(y(2))*getPowerDeriv(T52,(-params(1)),1);
  g1(5,3)=T121;
  g1(5,8)=(-exp(y(8)));
  g1(6,2)=T50*exp(y(2))*getPowerDeriv(T52,(-params(1)),1);
  g1(6,3)=T55*exp(y(3))*getPowerDeriv(exp(y(3)),params(2),1)+T50*T121;
  ...
  g1(9,9)=1;
  g1(10,10)=1;
  g1(11,1)=(-(params(6)*exp(y(1)-params(11))+params(6)*(exp(y(1)-params(11))+y(1)*exp(y(1)-params(11)))));
  g1(11,11)=1;
  g1(12,11)=(-1);
  g1(12,12)=exp(y(12));
  if ~isreal(g1)
