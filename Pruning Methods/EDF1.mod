...
%% Notes Use dynare 4.4.3/contrib/nmla to run these codes for EDF1.
%%addpath C:\dynare\4.4.3\contrib\nlma
var  d, c, h, y, i, k, a, lambda,  tb_y, ca_y, r ,util,beta_fun;  
...
stoch_simul(order = 3 , irf = 0, periods = 0,k_order_solver, drop = 1000);
