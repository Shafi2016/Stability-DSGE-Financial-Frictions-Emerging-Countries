%% IDEIR Model with additive Risk Premium, Call it IDEIR(a)
...
parameters  gamma, omega, rho, sigmae, delta, psi, alpha, phi, beta, r_w, d_bar;
		 ...
		 omega  = 1.6;
          delta  = 0.03;
          // psi = 0.00104;//fernandez-villaverde_et_al
         psi = 0.00192;// andreasen
          // psi    = 0.000002; //Den Haan Pruning 
         //  psi = 0.00187; //lan_meyer-gohde
        // psi = 0.000000011; with out pruning
           //psi = 0.00189; //NLMA
          sigmae = 0.0201;
         beta   = 1/(1+r_w);
